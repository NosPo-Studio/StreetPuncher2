...
return function(pc, x, y, particle, particleAmount, force, args, addedForceX, addedForceY)
	particleAmount = particleAmount * global.ut.parseArgs(global.conf.particles, 1)
	addedForceX = global.ut.parseArgs(addedForceX, 0)
	addedForceY = global.ut.parseArgs(addedForceY, 0)
	...
	for c = 1, particleAmount do
		...
		p.gameObject:addForce(fx + addedForceX, fy + addedForceY)
	end
end